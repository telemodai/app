...
<template>
  <a
    ...
    class="inline-flex max-w-full items-center gap-1 rounded-full border border-line bg-surface-3 px-2 py-0.5 text-2xs font-medium normal-case tracking-normal text-fg-muted transition-colors hover:border-line-strong hover:bg-surface-2 hover:text-fg"
