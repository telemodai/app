...
**Billing:** SaaS mode (`DEPLOYMENT_MODE=saas`) — user wallet + per-bot operating balance, YooKassa checkout on account page, purchase promo codes, referral rewards to user wallet. Self-hosted default — BYOK, billing no-op. See `.docs/billing-design.md`, `.docs/billing-economics.md`.
